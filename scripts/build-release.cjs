...
for (const rel of [
  ...
  'bin/prototype-core.cjs',
  'bin/prototype-coverage.cjs',
  'bin/prototype-output.cjs',
  'bin/deterministic-zip.cjs',
  'bin/render-html-prototype.cjs',
  'bin/render-figma-bundle.cjs',
  'bin/render-sketch-document.cjs',
  'bin/render-axure-handoff.cjs',
  'bin/export-editable-prototype.cjs',
  'bin/install-transaction-core.cjs',
  'docs/editable-prototype-handoff.md',
  'test/editable-prototype.cjs',
  'test/editable-prototype-upgrade.cjs',
  'test/editable-prototype-benchmark.cjs',
...
for (const rel of [
  ...
  '.agents/skills/workflow-02d-editable-prototype/SKILL.md',
  '.codebuddy/rules/agent-workflow.md',
  '.codebuddy/commands/04-代码实现.md',
  '.codebuddy/commands/02D-可编辑原型交付.md',
  ...
  'workflow/bin/prototype-core.cjs',
  'workflow/bin/prototype-coverage.cjs',
  'workflow/bin/prototype-output.cjs',
  'workflow/bin/deterministic-zip.cjs',
  'workflow/bin/render-html-prototype.cjs',
  'workflow/bin/render-figma-bundle.cjs',
  'workflow/bin/render-sketch-document.cjs',
  'workflow/bin/render-axure-handoff.cjs',
  'workflow/bin/export-editable-prototype.cjs',
